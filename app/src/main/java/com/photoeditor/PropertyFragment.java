...
public class PropertyFragment extends BottomSheetDialogFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ColorPickAdapter colorPickerAdapter = new ColorPickAdapter(getActivity());
        colorPickerAdapter.setOnColorPickerClickListener(new ColorPickAdapter.OnColorPickerClickListener() {
            @Override
