...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void shLoad(@NonNull String message) {
        progressDial = new ProgressDialog(this);
        progressDial.setMessage(message);
    ...
    protected void shSnackBar(@NonNull String message) {
